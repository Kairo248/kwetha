...
export function SiteBrandMark({ size = "header", className = "" }: SiteBrandMarkProps) {
  ...
  return (
    <span
      className={`inline-flex shrink-0 items-center justify-center rounded-2xl bg-stone-900 ring-1 ring-black/15 dark:bg-stone-950 dark:ring-white/10 ${footer ? "px-3 py-2 sm:px-4 sm:py-2.5" : "px-2 py-1.5 sm:px-2.5 sm:py-2"} ${className}`}
    >
      <Image
